...
public class EventMapper {
    ...
    public static Event toEventFromInputDto(EventInputDto eventInputDto, Category category, User initiator) {
        return Event.builder()
                ...
                .initiator(initiator)
                .location(eventInputDto.getLocation())
    ...
    public static EventInputDto toEventInputDtoFromUpdate(EventUpdateDto update, Event oldEvent) {
        return EventInputDto.builder()
                ...
                //.initiator(oldEvent.getInitiator().getId())
                ...
                //.state(oldEvent.getState().equals(EventState.CANCELED) ? EventState.PENDING : oldEvent.getState())
                //.createdOn(LocalDateTime.now())
                .build();
    }
}
